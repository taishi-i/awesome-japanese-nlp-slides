...
このリストの資料 604 件を Claude Code から検索できるプラグインを用意しています。
...
🌐 企業や個人開発者が公開しているブログ記事・技術記事は[こちらの記事一覧](https://github.com/taishi-i/awesome-japanese-nlp-slides/blob/main/docs/ARTICLES.ja.md)に別途まとめています（150 件）。
