...
314 decks across 23 categories.
...
A plugin is available to search all 314 decks in this list from Claude Code.
...
> [!TIP]
> You can search in either Japanese or English. The output language follows the language of your query.
...
- [Speech & Dialogue Systems](#speech--dialogue-systems)
...
Speech recognition and synthesis, plus spoken and text dialogue systems.
