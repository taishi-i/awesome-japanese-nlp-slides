...
我們提供了外掛，讓你可以從 Claude Code 搜尋本清單收錄的 667 份資料。
...
🌐 企業與個人開發者發布的部落格文章，另外整理於[這份文章清單](https://github.com/taishi-i/awesome-japanese-nlp-slides/blob/main/docs/ARTICLES.zh-hant.md)（190 篇）。
