...
← 回到[投影片清單](https://github.com/taishi-i/awesome-japanese-nlp-slides/blob/main/docs/README.zh-hant.md)

這是一份精選清單，收錄了日語自然語言處理（NLP）相關、由企業與個人開發者撰寫的網頁與部落格文章。
採用與[投影片清單](https://github.com/taishi-i/awesome-japanese-nlp-slides/blob/main/docs/README.zh-hant.md)相同的 32 個主題分類。

共收錄 190 篇文章，分為 32 個分類。

文章標題保留發表時的原文，因此絕大多數為日語。

> [!NOTE]
> 本清單持續更新中，會不斷新增文章、充實內容。
...
> [!NOTE]
> CC0 適用的對象是本清單本身。各篇文章的著作權，歸屬於各自的作者或企業。
