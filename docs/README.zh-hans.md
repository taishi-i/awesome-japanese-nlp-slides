...
我们提供了插件，让你可以从 Claude Code 搜索本列表收录的 655 份资料。
...
🌐 企业与个人开发者发布的博客文章，另外整理于[这份文章列表](https://github.com/taishi-i/awesome-japanese-nlp-slides/blob/main/docs/ARTICLES.zh-hans.md)（180 篇）。
